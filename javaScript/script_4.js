...
let alphJour = journaliste.sort();
console.log("Trie la liste de handles par ordre alphabétique.");
console.log(alphJour);

let shortJour = journaliste.sort((a, b) => a.length - b.length);
console.log("Quels sont les 50 handles les plus courts de cette array ?");
console.log(shortJour);

let epenser = journaliste.indexOf('@epenser')
